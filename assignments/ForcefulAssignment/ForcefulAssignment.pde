...
//Initialize another, stationary, attractor object
Globe g;
...
void setup() {
  size(640, 360);
  noSmooth();
  noise = new Movie(this, "dream.mp4");
  noise.loop();
  ...
  //create a stationary attractor
  g = new Globe("globe.png");
...
void draw() {
  background(255);
  image(noise, 0, 0, noise.width, noise.height);
  sludge.display();
